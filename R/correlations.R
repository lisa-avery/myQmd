# correlations.R
# Correlation estimation with CIs, GEE-based correlated performance,
# paired diagnostic comparison, and Efron's optimism-adjusted kappa.
#
# Depends on: format_utils.R (rnd, formatp, psthr)
# Suggests packages: dplyr, tidyr, reportRmd, psych, geepack, tibble
