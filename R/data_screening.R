# data_screening.R
# Variable metadata, screening and summary helpers, plus small data-frame
# utilities (stratified subsampling, recoding cross-tabs, sample-size for a
# margin of error) and an Excel date reader.
#
# NOTE: data_import.R provides a richer dictionary-driven pipeline
#       (get_var_info(), clean_data(), create_dictionary()); the lighter
#       getVarInfo()/clean_names() here are kept for quick ad-hoc screening.
#
# Suggests packages: dplyr, janitor, lubridate, rlang
